...
<?php
    ...
    $lblGroupName   = Helper::cmsLinkSort('Group Name', 'name', $columnPost, $orderPost);  
?>
                    ...
                    <div id="j-main-container">
                        ...
                        <table class="table table-striped" id="moduleList">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr class="<?php echo $row; ?>" sortable-user-id="position-<?php echo $id; ?>">
                                    ...
                                    <td class="small hidden-phone hidden-tablet"><?php echo $fullname; ?></td>
