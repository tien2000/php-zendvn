...
-- số thập phân.
SELECT FORMAT(123.345234, 3);
SELECT FORMAT(123.645234, 0);
...
SELECT INSERT('MySQL is easy', 3, 3, 'Libery');  -- thay thế chữ SQL
SELECT INSERT('MySQL is easy', 3, 100, 'Libery');  -- thay thế hết câu
...
SELECT SUBSTRING('MySQL is very easy' FROM 2 FOR 5);
...
SELECT TRIM('       MySQL   is   very   easy     ');
SELECT TRIM(LEADING '-' FROM '--------------MySQL is very easy--------------');
SELECT TRIM(TRAILING '-' FROM '--------------MySQL is very easy--------------');
SELECT TRIM(BOTH '-' FROM '--------------MySQL    is    very    easy--------------');
